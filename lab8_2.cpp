...
Fahsai: I think you are an Engineering student. What is your student ID?N
...
int main(){
    ...
    string name,movie,day,sentences,sp = ": ";
    char en  = '\n';
    int gear,yearnum;
    ...
    cout << "Fahsai: "<< day << "....that is OK!!! I'm looking forward to watching " << movie<<" with you."<<en <<name<<sp;
    cin.ignore();
